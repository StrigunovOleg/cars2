    ...
    return (
        <footer id="footer" className="bg-gray-800 text-white py-6">
            <div className="flex md:flex-row flex-col-reverse items-center justify-around">
                ...
                <div className="w-48 h-full flex flex-col items-center justify-around">
                <h3 className="text-2xl">Контакты</h3>
                <a className="underline text-xl underline-offset-4" href="mailto:autodelivery03@mail.ru">autodelivery03@mail.ru</a>
                <a className="underline text-xl underline-offset-4" href='tel:89089921879'>+7 908 992-18-79</a>
                <a className="underline text-xl underline-offset-4" href='tel:89084645000'>+7 908 464-50-00</a>
                <a className="underline text-xl underline-offset-4" href='tel:89089921879'>+7 953 219-90-88</a>
                <div className="flex items-center justify-around">
                  <a className="rounded-xl mx-2 my-2" href="https://t.me/upgrade_autovl">
...
<path fill="#D8D7DA" d="M200.31,338.967l-0.513-82.428c-0.003-0.528,0.27-1.018,0.72-1.293l133.899-81.798
	...
	C202.426,341.045,200.32,340.538,200.31,338.967z"/>
                  ...
                  <svg height="50px" width="50px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" 
